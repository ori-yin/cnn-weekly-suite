...
| 下单转化率 | 点击后下单人次 / 点击人次 × 100% | 点击→下单转化率 |
...
| 计划类型 | 触达成功 | 点击人次 | CTR | 订单GC | 下单转化率 | 状态 |
|---|---|---|---|---|---|---|
| ▶ AARR | XX | XX | XX% | XX | XX% | 绿/黄/红 |

**展开后渠道明细**：

| 渠道 | 触达成功 | 点击人次 | CTR | 订单GC | 下单转化率 | 状态 |
|---|---|---|---|---|---|---|
...
| BU（预算owner） | Plan 数 | 触达成功 | 点击人次 | CTR | 订单GC | 下单转化率 | 状态 |
|---|---|---|---|---|---|---|---|
...
| 排名 | Plan ID | 文案 | BU | 触达 | CTR | 下单转化率 | 综合评分 | 可复用点 |
|---|---|---|---|---|---|---|---|---|
| 1 | ... | ... | ... | ... | ... | ... | ... | ... |
| 2 | ... | ... | ... | ... | ... | ... | ... | ... |
| 3 | ... | ... | ... | ... | ... | ... | ... | ... |
...
| 排名 | Plan ID | 文案 | BU | 触达 | CTR | 下单转化率 | 综合评分 | 优化方向 |
|---|---|---|---|---|---|---|---|---|
| 1 | ... | ... | ... | ... | ... | ... | ... | ... |
| 2 | ... | ... | ... | ... | ... | ... | ... | ... |
| 3 | ... | ... | ... | ... | ... | ... | ... | ... |
...
- CTR/下单转化率 使用分段函数（Q3 阈值以下幂次归一化，以上满分）
- 置信度惩罚基于触达规模
- 综合评分 = 触达规模×30% + CTR×40% + 下单转化率×30%
